    ...
    <div className="space-y-12 text-lg tracking-wide py-40 max-w-5xl mx-auto">
      ...
      <div className="space-y-5">
        ...
        <p className="text-justify  font-light">
          Le massage thérapeutique est sans doute la méthode la plus prisée dans
          le milieu des médecines naturelles. Sa pratique s'étend à un grand
          nombre d'individus, des très jeunes enfants aux personnes âgées, que
          l'on hésiterait à confier aux soins plus vigoureux de pratiques comme
          la chiropratique, par exemple. Certains cabinets de massage se
          spécialisent même dans le traitement des animaux domestiques
          souffrants de malformations ou de douleurs arthritiques.
        </p>
        <p className="text-justify font-light">
          ...
          compétente : le thérapeute professionnel et peut porter sur certaines
          zones précises du corps ou sur le corps entier.
        </p>
      ...
      <div className="space-y-5">
        ...
        <p className="text-justify font-light">
          Un massage thérapeutique ne s’apparente en aucun cas à un luxe : c’est
          une nécessité à laquelle il est conseillé d’avoir recours. Par des
          pressions effectuées sur les parties à traitées ou sur l’intégralité
          du corps, ce type de massage peut, en effet,{' '}
          ...
          pas d'effets secondaires. Il provoque des effets bénéfiques puissants
          sur les articulations ainsi que la circulation sanguine.
        </p>
      </div>
      <div className="space-y-5">
        <h2 className="text-2xl font-semibold">
        ...
        <p className="text-justify font-light">
          ...
          Par ailleurs{' '}
          <strong>
            il optimise le fonctionnement de la circulation lymphatique, ce qui
            a pour effet d’augmenter la capacité de l’organisme à éliminer les
            toxines.
          </strong>
        </p>
        <p className="text-justify font-light">
