    ...
    <div className="space-y-12 text-lg tracking-wide py-40 max-w-5xl mx-auto">
      ...
      <div className="space-y-5">
        ...
        <p className="text-justify font-light">
          ...
          diverses pathologies. En créant une succion sur la peau, les ventouses
          stimulent la circulation sanguine et lymphatique, ce qui aide à
          soulager les douleurs, libérer les tensions et favoriser l’élimination
          des toxines. Ce soin est particulièrement recommandé pour traiter des
          troubles chroniques ou ponctuels, tout en étant sans effets
          secondaires. Il agit profondément sur le corps tout en stimulant ses
      ...
      <div className="space-y-5">
        ...
        <p className="text-justify font-light">
          ...
          permet de soulager de nombreuses pathologies. Il est reconnu pour son
          action sur les douleurs articulaires, comme l'arthrose et les
          rhumatismes, ainsi que sur les douleurs nerveuses, comme les
          névralgies et la sciatique. Ce traitement est également très bénéfique
          pour les douleurs dorsales et musculaires, offrant un soulagement
          profond et durable.
        </p>
        <p className="text-justify font-light">
        ...
        <p className="text-justify font-light">
          ...
          une relaxation profonde tout en améliorant la souplesse des muscles et
          des articulations. Sur le plan global, il favorise une meilleure santé
          et un bien-être général tout en traitant efficacement des douleurs et
          des troubles variés.
        </p>
      </div>
