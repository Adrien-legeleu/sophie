    ...
    <div className="space-y-12 text-lg tracking-wide py-40 max-w-5xl mx-auto">
      ...
      <div className="space-y-5">
        <p className="text-justify  font-light">
          ...
          longtemps considéré à tort les champs électromagnétiques de tissus et
          d'organes comme un produit secondaire de l'activité cellulaire et donc
        ...
        <p className="text-justify  font-light">
          ...
          chevilles, l’appareil établit un test en enregistrant toutes les ondes
          électromagnétiques émises par tous les organes de votre corps. Les
          résultats de <strong>
            la mesure du champ vital , le Vitafeld,
          </strong>{' '}
          sont illustrés de différentes manières. On peut par exemple tirer des
          conclusions sur la résistance, la capacité de régulation et le contenu
          toxique de la personne.
        </p>
        <p className="text-justify  font-light">
          <strong> Le traitement s'opère directement après les mesures.</strong>
        </p>
        <p className="text-justify  font-light">
        ...
        <p className="text-justify  font-light">
          <strong>Très rapidement une décontraction se fait sentir </strong> et
          les dépressions peuvent diminuer. Par ailleurs, toutes les cellules
          sont remises dans leur bonne fréquence, ce qui libère les toxines.
        </p>
      ...
      <p className="text-justify font-light">
        Allongé(e), vous n’avez plus qu'à vous relaxer en pensant exclusivement
        à votre bien-être durant les 30 à 40 minutes de traitement.{' '}
        <strong>
      ...
      <div className="space-y-5">
        <h2 className="text-2xl font-semibold">
          La biorésonance est efficace pour traiter les d'allergies aux pollens
        </h2>
        <p className="text-justify font-light">
          Comme le montre le reportage de la RTS ci-dessous, la biorésonance
          représente une solution fiable et peu coûteuse pour en finir avec les
          allergies.
        </p>
      </div>
      ...
      <div className="space-y-5">
        ...
        <p className="text-justify font-light">
          En soutien aux personnes en traitement médicamenteux (chimiothérapies,
          radiothérapies, traitements hormonaux, etc.) · Aux personnes souffrant
          d’allergies, de fatigue chronique, de baisse de rendement, de malaises
          indéfinis · Aux personnes en bonne santé désirant maintenir leur
          vitalité
        </p>
      </div>
      <div className="space-y-5">
        ...
        <p className="text-justify font-light">
          Après la réalisation d'un bilan énergétique complet du corps (tous les
          organes, les articulations, les vertèbres, les muscles), l’ensemble
          des systèmes corporels (système digestif, respiratoire, immunitaire,
          endocrinien) l'on procède ensuite au traitement de rééquilibrage
          énergétique parfois en plusieurs séances.
        </p>
      </div>
      <div className="space-y-5">
        <h2 className="text-2xl font-semibold">
        ...
        <p className="text-justify font-light">
          Chaque composante de l'organisme et chaque système, qu'il soit malade
          ou sain, a un type de réponse spécifique à de faibles stimulations
          extérieures. Ce modèle réactionnel permet de tirer des conclusions
          très précises sur votre état énergétique actuel et sur le
          fonctionnement énergétique des organes examinés pour réaliser des
