  ...
  return (
    <div className="lg:hidden">
      <button
        ...
        className="fixed top-4 right-4 z-50 p-2 bg-white rounded-2xl shadow-lg"
      >
        {isMenuOpen ? <IconX size={24} /> : <IconMenuDeep size={24} />}
      </button>
            ...
            <li className="w-full">
              ...
              {openDropdown === 'soins' && (
                <ul className="mt-2 pl-4 text-center space-y-2 text-sm">
                  ...
                  <li>
                    <Link
                      href="/copie-de-massotherapie"
                      onClick={closeMenuToggle}
                    >
                      Copie de massothérapie
                    </Link>
                  </li>
                  <li>
