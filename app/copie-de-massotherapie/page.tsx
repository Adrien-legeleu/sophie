    ...
    <div className="space-y-12 text-lg tracking-wide py-40 max-w-5xl  mx-auto">
      ...
      <div className="space-y-5">
        ...
        <p className="text-justify font-light">
          ...
          relaxation. Réalisé par un praticien qualifié, il se concentre sur des
          zones spécifiques ou peut englober l’ensemble du corps.
        </p>
          ...
          <div className="basis-[60%] space-y-10">
            <div className="space-y-5">
              ...
              <p className="text-justify font-light">
                ...
                mental. Par des mouvements fluides et des pressions ciblées, il
                facilite la guérison tout en étant un remède 100% naturel sans
                effets secondaires. Il exerce des bienfaits profonds sur les
                muscles, les articulations, et la circulation sanguine.
              </p>
            </div>
            <div className="space-y-5">
              <h2 className="text-2xl font-semibold">
              ...
              <p className="text-justify font-light">
                ...
                circulation sanguine, il aide à prévenir les problèmes tels que
                les jambes lourdes ou les varices. De plus, il améliore la
